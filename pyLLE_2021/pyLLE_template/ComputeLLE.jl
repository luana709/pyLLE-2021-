...
#function SaveResults(dir, S)
 #   #h5file = dir * "ResultsJulia.h5"
	#resfile =  open(dir * "_ResultsJulia.txt" ,"w")
	#write(resfile,string(real(S["u_probe"])) * "\n")
#	write(resfile,string(imag(S["u_probe"])) * "\n")
#	write(resfile,string(real(S["Em_probe"])) * "\n")
#	write(resfile,string(imag(S["Em_probe"])) * "\n")
#	write(resfile,string(real(S["comb_power"])) * "\n")
#	write(resfile,string(imag(S["comb_power"])) * "\n")
#	write(resfile,string(real(S["detuning"])) * "\n")
#	write(resfile,string(imag(S["detuning"])) * "\n")
#	write(resfile,string(S["detuning"]) * "\n")
#	close(resfile)
#end
#
